        ...
        <div className="sticky">
            ...
            <div className="flex flex-row">
                ...
                <Link href="https://github.com/mayssam73">
                    <FontAwesomeIcon icon={["fab", "github"]} rotation={270} size="2xl" className="ml-4 mt-[64vh]"/>
                </Link>
                <Link href="https://www.linkedin.com/in/mayssam-kalajo/">
                    <FontAwesomeIcon icon={["fab", "linkedin"]} rotation={270} size="2xl" className="-ml-7 mt-[69vh]"/>
                </Link>
            </div>
        </div>
    );
